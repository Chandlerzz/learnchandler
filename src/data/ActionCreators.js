...
export const loadData = (dataType, params) => (
    ...
    export const loadDataIdioms = (dataType, params) => (
        {
            type: ActionTypes.DATA_LOAD,
            payload: dataSource.GetData(dataType, params).then(response =>
                 ({ dataType,
...
export const idiomsSearch = (word) =>{
    return ({type:ActionTypes.IDIOMS_SEARCH, payload: word})
}
export const setUpdateValue = (updatedValue) =>{
    return ({type:ActionTypes.SET_UPDATE_VALUE, payload: updatedValue})
}
